...
❌ 严重不对齐 User - 55.6%
  ...
  ⚠️  TS缺少字段: last_login_at, password_hash, pin_hash, phone_hash, email_hash
  ⚠️  Python缺少字段: shift, department, nurse_group, certifications
  ⚠️  类型不匹配:
...
⚠️ 部分对齐 Tenant - 85.7%
  ...
  ⚠️  Python缺少字段: contact_phone, license_type, max_users, address, max_residents
      ... 等共7个
  ⚠️  类型不匹配:
