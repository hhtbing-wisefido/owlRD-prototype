...
.windsurf/
 ...
 rules/                             规则文件目录
     00-核心工作原则.md            (Always On)
     01-文件操作规范.md            (Always On)
     02-目录管理规范.md            (Always On) - 含严格目录控制
     03-文件命名规范.md            (Always On)
     04-变更同步规则.md            (Always On)
     05-README管理规范.md          (Always On)
     06-测试组织规范.md            (Always On) - 已修复转义
     07-Emoji文档风格规范.md       (Always On) - 🎨 v4.1新增
     08-知识库管理规范.md          (Always On) - 🔒 v4.2新增
     09-项目结构与配置.md          (Always On) - ✨ v5.1合并优化
```

**激活模式说明**：
- 🔴 **Always On** (10个) - 全部自动应用，无需手动调用
...
| 编号 | 文件名 | 说明 | 优先级 | 备注 |
|------|--------|------|--------|------|
| 00 | 核心工作原则.md | AI基本工作原则+自检机制 | 🔴 最高 | ✨ 已合并原08 |
| 01 | 文件操作规范.md | 文件创建/修改/删除规则 | 🔴 高 | ✅ 已修复引用 |
| 02 | 目录管理规范.md | 目录结构+严格目录控制 | 🔴 高 | ✨ 已合并原07 |
...
| 09 | 项目结构与配置.md | 项目结构识别与配置 | 🟡 中 | ✨ v5.1合并05+06 |
