...
### WebSocket连接
```javascript
const ws = new WebSocket('ws://192.168.1.100:8000/api/v1/realtime/ws/tenant-id');
```

### API调用
```javascript
fetch('http://192.168.1.100:8000/api/v1/tenants?limit=10')
  .then(res => res.json())
...
| 局域网IP | http://your-ip:8000 | http://192.168.1.100:8000/docs |
| WebSocket | ws://your-ip:8000/api/v1/realtime/ws/{tenant_id} | ws://192.168.1.100:8000/api/v1/realtime/ws/test |
