...
```python
allowed_items = {
    '.git', '.vscode', '.windsurf/rules', 'project-code',  # ⚠️ 硬编码！
    'scripts', '知识�?, '项目文档',
    '.gitignore', 'README.md',
    # ...
}
...
```python
backend_dir = project_root / "project-code" / "backend"   # ⚠️ 硬编码！
frontend_dir = project_root / "project-code" / "frontend" # ⚠️ 硬编码！
```
...
```python
report_dir = PROJECT_ROOT / "project-code" / "tests" / "test_reports"  # ⚠️ 硬编码！
```
